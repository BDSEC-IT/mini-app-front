...
const ProfileCreateForm: React.FC<ProfileFormType> = ({
  ...
  const title = initialData ? 'Edit product' : t('Account');

  const description = initialData
    ? 'Edit a product.'
    : t('createProDescription');
  ...
  const countries = [{ id: 'wow', name: 'mongolia' }];
  const cities = [{ id: '2', name: 'ulaanbaatar' }];
