      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 flex-shrink-0">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl outline-none  text-[16px] bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-small"
            autoFocus
          />
        </div>
      </div>
